...
const paperNormalMap2 = await (new THREE.TextureLoader()).loadAsync('./texture5.jpg');
...
const fontSansSerifURL = "./helvetiker_regular.typeface.json";
...
function BookSpine() {
    ...
    meshTitle.position.set(-3, -bookH/2 + bookBorderL + 7, bookD/2 - 16);
...
const light = new THREE.DirectionalLight(0xFFE8C0, 0.6);
...
light.shadow.radius = 120;           // add — this is what actually creates the blur, only works with VSM/PCFSoft
